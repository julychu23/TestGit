 ...
 * Original file: E:\\WorkSpace\\AidlService\\src\\cn\\jc\\aidlservice\\ICat.aidl
 */
package cn.jc.aidlservice;
public interface ICat extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements cn.jc.aidlservice.ICat
{
private static final java.lang.String DESCRIPTOR = "cn.jc.aidlservice.ICat";
...
/**
 * Cast an IBinder object into an cn.jc.aidlservice.ICat interface,
 * generating a proxy if needed.
 */
public static cn.jc.aidlservice.ICat asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof cn.jc.aidlservice.ICat))) {
return ((cn.jc.aidlservice.ICat)iin);
}
return new cn.jc.aidlservice.ICat.Stub.Proxy(obj);
}
...
private static class Proxy implements cn.jc.aidlservice.ICat
{
